...
def train_mlp(
    *,
    ...
    final_train_loss, train_accuracy = evaluate(model, train_features, train_targets, loss_function)
    eval_loss, eval_accuracy = evaluate(model, eval_features, eval_targets, loss_function)
    learned = final_train_loss < initial_loss * 0.35 and eval_accuracy >= 0.95
